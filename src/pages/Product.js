    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 w-1/3 focus:outline-none hover:bg-red-600 rounded text-lg">Add to Cart <ShoppingCartIcon className='ml-2 w-8 h-8'/></button>
