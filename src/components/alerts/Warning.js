...
function Warning(props) {
  return <>
        <div className="bg-orange-200 absolute px-6 py-4 shadow-2xl z-50 right-0 mx-5 my-4 rounded-3xl text-lg flex items-center mx-auto" >
            ...
            <span className="text-yellow-800">{props.message}</span>
        </div>
  </>;
}
